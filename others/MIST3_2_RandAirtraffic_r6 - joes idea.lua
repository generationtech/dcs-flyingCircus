...
do
--EDIT BELOW
intervall = math.random(60,180) 	--random repeater intervall between (A and B) in seconds
...
AF1 = 'Vaziani' 					--Exact name of airfield with the zone "Batumi"
AF2 = 'Soganlug' 					--Exact name of airfield with the zone "Kobuleti"
AF3 = 'Tbilisi-Lochini'					--Exact name of airfield with the zone "Kutaisi"
trafficzone = 'Three'			--Excact name of triggerzone which generates turning point for flights between airfields.
...
function generateAirplane()
	...
	LogisticOrHeliOrFighter = math.random(1,2) --random for transport, heli or fighter
